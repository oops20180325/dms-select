            ...
            <div class="options_box" v-if='showoptions' >
                ...
                <!-- 确定抛出信息就行 -->
                  ...
                  <div class="content" >
                      ...
                      <p v-show="noMessageShow" style="border-top:1px solid #ccc; margin: 0; padding:10px 0"><span>无匹配数据</span></p>
                  </div>
              </div>
          </transition>
    </div>
  ...
  computed:{
    filterOptions(){
      let newArr = this.optionsList.filter((value,index)=>{
        let flag = this.iptContent;
        // console.log('flag',flag)
        // console.log(typeof flag)
        // console.log(value)

        return value.title.indexOf(flag)!= -1;
      })
